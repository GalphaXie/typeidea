...
class Link(models.Model):
    ...
    weight = models.PositiveIntegerField(default=1, choices=zip(range(1, 6), range(1, 6)), verbose_name="权重", help_text="权重高展示数据靠前")
...
class SideBar(models.Model):
    ...
    @classmethod
    def get_all(cls):
        return cls.objects.filter(display_type=cls.STATUS_SHOW)
